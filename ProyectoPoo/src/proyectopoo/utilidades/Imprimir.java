...
public class Imprimir{
    ...
    public static void printAlum(List<Alumno> listaDeAlumnos){    //recibe coleccion lista
    ...
    public static void printAlumT(List<Alumno> listaDeAlumnos){   ////recibe coleccion lista
        for(int i = 0; i < listaDeAlumnos.size(); i++){
    ...
    public static void printGrup(Hashtable<String,Grupo> mapDeGrupos){  ////recibe coleccion mapa
        String clave;
        Grupo valor;
    ...
    public static void printGrupT(Hashtable<String,Grupo> mapDeGrupos){   ////recibe coleccion mapa
        String clave;
        Grupo valor;
        Enumeration <String> claves = mapDeGrupos.keys(); //se crea un objeto enumerarion para recorrer el mapa de grupos, pues no es iterable
    ...
    public static void printProf(List<Profesor> listaDeProfesores){    ////recibe coleccion lista
    ...
    public static void printProfT(List<Profesor> listaDeProfesores){ ////recibe coleccion lista
        for(int i = 0; i < listaDeProfesores.size(); i++){
            Profesor p =    listaDeProfesores.get(i);   //crea un profesor auxiliar para poder usar los métodos de dicho objeto en la impresion de datos
            System.out.print((i+1)+".- ");
            p.printT();
    ...
    public static void printAsig(List<Asignatura> listaDeAsignaturas){     ////recibe coleccion lista
    ...
    public static void printAsigT(List<Asignatura> listaDeAsignaturas){    ////recibe coleccion lista
        for(int i = 0; i < listaDeAsignaturas.size(); i++){
            Asignatura p = listaDeAsignaturas.get(i);   //crea una asignatura auxiliar para poder usar los métodos de dicho objeto en la impresion de datos
            System.out.print((i+1)+".- ");
            p.printT();
